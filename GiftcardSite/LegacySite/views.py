...
def register_view(request):
    if request.method == 'GET':
        ...
        # We should remove password monitoring since it would expose the password we generated
        # Otherwise when we create an new account, in /metrics, the password in plaintext would display
